...
async def generate_thumbnail(
    ...
    try:
        ...
        def draw_text_with_shadow(x, y, text, font, fill, shadow_color=(0, 0, 0)):
            draw.text((x+2, y+2), text, font=font, fill=shadow_color)
            draw.text((x, y), text, font=font, fill=fill)
        
        # Title and artist
        draw_text_with_shadow(400, 200, title[:30], font_title, (255, 255, 255))
        draw_text_with_shadow(400, 250, f"by {artist}", font_artist, (200, 200, 200))
        
        # Duration and time
        draw_text_with_shadow(400, 300, f"Duration: {format_duration(duration)}", 
                            font_info, (150, 150, 150))
        draw_text_with_shadow(400, 330, f"Time: {datetime.now().strftime('%H:%M')}", 
                            font_info, (150, 150, 150))
        ...
        if requester_id:
            try:
                ...
                draw_text_with_shadow(400, 420, f"Requested by: {user.first_name}", 
                                    font_info, (100, 100, 255))
            except Exception:
                pass
        
        # Branding
        draw_text_with_shadow(50, 550, "Jhoom Music Bot", font_info, (255, 255, 255))
        ...
        # Return simple fallback thumbnail
